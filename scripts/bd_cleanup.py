...
excel_file_path = './executive_reports/bd_executive_report.xlsx'
csv_file_path = './temp/bd_executive_report.csv'  
...
reordered_file_path = './temp/bd_reordered_columns.csv'
df.to_csv(reordered_file_path, index=False)

print("BD report clean up is ongoing...")
