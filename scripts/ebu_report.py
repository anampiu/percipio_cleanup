...
exec_report_path = './temp/ebu_executive_report.csv'
exec_report_df = pd.read_csv(exec_report_path)

# Define course files and their corresponding columns
course_columns = {
    './temp/ebu_courses/AI.csv': 'AI 101',
    './temp/ebu_courses/Commercial Management.csv': 'Commercial Management',
    './temp/ebu_courses/Data Analytics.csv': 'Data Analytics 101'
}
...
exec_report_df.to_csv('./reports/ebu_updated_executive_report.csv', index=False)
